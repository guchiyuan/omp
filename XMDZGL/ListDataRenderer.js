...
define(["dojo/Evented",
  ...
  var editAndDeleteTpl = '<div class="info-box">' +
    '<div class="info-box-opt">' +
    '<span class="iconfont text-primary info-box-btn-edit" title="编辑" data-uid="{{uid}}">&#xe637;</span>' +
    '<span class="iconfont text-primary info-box-btn-delete" title="删除" data-uid="{{uid}}">&#xe640;</span>' +
    '</div>' +
    '<div class="info-box-content">' +
